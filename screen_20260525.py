#!/usr/bin/env python3
"""Run initial screening on 20260525 batch papers. Writes results to yujing_quanliang table."""
import json
import logging
import sys
import time
...
log = logging.getLogger("screen-20260525")

BASE = Path(__file__).resolve().parent
INPUT_BASE = BASE / "data" / "input" / "20260525"
...
def main():
    ...
    output_path = OUTPUT_BASE / "20260525_screening_results.json"
